...
\end{verbatim}
  ...
  \item 全銘柄について filtered parquet を作る．
\begin{verbatim}
...
\begin{verbatim}
uv run python -m taq_llag_analysis.write_trade_quote_mode_summary \
  --date 20251031 \
  --date 20251103 \
...
\end{verbatim}
  ...
  \item \texttt{notebooks/trade\_quote\_mode\_symbol\_panel.py} を開き，
